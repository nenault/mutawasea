  ...
  sail(newBoat, randomDestination) {
    ...
    if (randomDestination === 1) {
      let calcY =
        ...
        newBoat.getBoundingClientRect().height * 4 - departArea;
      ...
      if (
        ...
        let calcX =
        lampedusaPort.getBoundingClientRect().left -
          newBoat.getBoundingClientRect().left + newBoat.getBoundingClientRect().width*2;
        newBoat.style.transitionDuration = "5s";
        newBoat.style.transform = `translate(${calcX}px, ${0 - calcY}px)`;
      } else {
        let calcX =
          newBoat.getBoundingClientRect().left -
          lampedusaPort.getBoundingClientRect().right - newBoat.getBoundingClientRect().width*2;
      ...
      if (
        ...
        let calcX =
          newBoat.getBoundingClientRect().left -
          maltaPort.getBoundingClientRect().right - newBoat.getBoundingClientRect().width*2;
        let subCalcX = 0 - calcX - newBoat.getBoundingClientRect().width*4;
      ...
      if (
        ...
        let calcX =
          newBoat.getBoundingClientRect().left -
          pozzalloPort.getBoundingClientRect().right - newBoat.getBoundingClientRect().width*2;
        let subCalcX = 0 - calcX - newBoat.getBoundingClientRect().width*4;
      ...
      if (
        ...
        let calcX =
          newBoat.getBoundingClientRect().left -
          messinaPort.getBoundingClientRect().right - newBoat.getBoundingClientRect().width*2;
        let subCalcX = 0 - calcX - newBoat.getBoundingClientRect().width*4;
      ...
      if (
        ...
        let calcX =
          newBoat.getBoundingClientRect().left -
          crotonePort.getBoundingClientRect().right - newBoat.getBoundingClientRect().width*2;
        let subCalcX = 0 - calcX - newBoat.getBoundingClientRect().width*4;
      ...
      if (
        ...
        let calcX =
          newBoat.getBoundingClientRect().left -
          tarantoPort.getBoundingClientRect().right - newBoat.getBoundingClientRect().width*2;
        let subCalcX = 0 - calcX - newBoat.getBoundingClientRect().width*4;
